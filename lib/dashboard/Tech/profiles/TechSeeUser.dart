...
class _TsUState extends State<TsU> {
  Future<void> getuserworkord(String uname, String Wname) async {
    final response = await http.get(
        Uri.parse('https://fani-service.onrender.com/ord/10/$uname/$Wname'));
    if (response.statusCode == 200) {
      final jsonResponse = json.decode(response.body);

      setState(() {
        userworkord = List<Map<String, dynamic>>.from(jsonResponse);
      });
  ...
  void initState() {
    ...
    getuserworkord(widget.userName, WorW['name']);
  }
